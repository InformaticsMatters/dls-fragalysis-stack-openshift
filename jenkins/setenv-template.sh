...
# A template for the environment variables.
# Copy this to setenv.sh, edit that and then `source setenv.sh`
# in order to setup the environment variables used by the configuration tool.
